...
export const readingLibrary: ReadingPassage[] = [
  ...
  {
    id: 'r17', title: 'The Origins and Evolution of the Silk Road', level: 'IELTS_B7', topic: 'History & Economy', sourceType: 'academic-ielts',
    content: 'The Silk Road was not a single thoroughfare from east to west, but an intricate network of trade routes that connected China and the Far East with the Middle East and Europe. Established during the Han Dynasty (206 BC – 220 AD), these routes were pivotal in facilitating not only the exchange of goods but also the unprecedented transmission of ideas, religion, and technology across diverse civilizations.\n\nThe genesis of this expansive network was largely driven by the Chinese imperial desire to secure the political stability of their western borders and acquire the heavily muscled horses bred in the Fergana Valley (modern-day Uzbekistan). These horses were essential for military campaigns against nomadic tribes. In exchange, the Chinese offered silk—a commodity that held a status akin to gold in the Roman Empire due to its luxurious texture and the closely guarded secret of its production.\n\nHowever, silk was merely the most celebrated among a myriad of commodities that traversed these routes. Caravans traveling westward carried spices, tea, porcelain, and inventions such as paper and gunpowder. Conversely, eastbound merchants brought glass, gold, silver, and precious stones. Beyond material wealth, the Silk Road functioned as an archaic internet, fostering the dissemination of knowledge. Buddhism, for instance, migrated from India to China and Japan, fundamentally altering the cultural and religious landscapes of East Asia.\n\nThe journey along the Silk Road was perilous, fraught with extreme geographic barriers like the Taklamakan Desert and the Pamir Mountains. Bandits frequently ambushed merchant caravans, prompting the establishment of caravanserais—fortified inns spaced approximately a day’s journey apart. These sanctuaries offered merchants and their pack animals water, food, and protection, simultaneously serving as vibrant hubs where travelers from myriad linguistic and cultural backgrounds exchanged news and ideas.\n\nBy the 15th century, the significance of the Silk Road began to wane. The advent of the Age of Discovery saw European powers pioneering maritime routes to Asia, which proved faster, cheaper, and safer than the arduous overland treks. Furthermore, the isolationist policies of the Ming Dynasty in China significantly reduced terrestrial trade. Despite its decline, the legacy of the Silk Road remains profound, representing the first era of globalization and the enduring human propensity for connection and exchange.',
    wordCount: 388,
    vocabularyHighlights: ['intricate', 'pivotal', 'transmission', 'genesis', 'myriad', 'perilous', 'dissemination', 'terrestrial'],
    questions: [
      { id: 'r17q1', type: 'true_false_not_given', question: 'The primary motivation for the Chinese to establish the Silk Road was to sell silk to the Roman Empire.', options: ['True', 'False', 'Not Given'], correctAnswer: 'False', explanation: 'The passage states the genesis was "largely driven by the Chinese imperial desire to secure the political stability of their western borders and acquire the heavily muscled horses", not primarily to sell silk.' },
      { id: 'r17q2', type: 'true_false_not_given', question: 'Caravanserais were primarily military forts used to house soldiers.', options: ['True', 'False', 'Not Given'], correctAnswer: 'False', explanation: 'They were "fortified inns" that "offered merchants and their pack animals water, food, and protection", not primarily for soldiers.' },
      { id: 'r17q3', type: 'multiple_choice', question: 'Which of the following best describes the decline of the Silk Road according to the passage?', options: ['It was destroyed by bandits in the 15th century.', 'Maritime routes became a superior alternative for trade.', 'The Roman Empire stopped buying silk.', 'The Fergana Valley horses became extinct.'], correctAnswer: 'Maritime routes became a superior alternative for trade.', explanation: 'The passage mentions "European powers pioneering maritime routes to Asia, which proved faster, cheaper, and safer".' },
      { id: 'r17q4', type: 'multiple_choice', question: 'The passage compares the Silk Road to the modern internet because:', options: ['It was very fast.', 'It facilitated the widespread sharing of knowledge and ideas.', 'It was a digital network.', 'It connected computers in different countries.'], correctAnswer: 'It facilitated the widespread sharing of knowledge and ideas.', explanation: 'The text says it "functioned as an archaic internet, fostering the dissemination of knowledge".' },
    ],
    tags: ['history', 'ielts-academic', 'reading-band-7']
  },
  {
    id: 'r18', title: 'Neuroplasticity: The Adaptable Brain', level: 'IELTS_B8', topic: 'Neuroscience', sourceType: 'academic-ielts',
    content: 'For centuries, the prevailing scientific consensus maintained that the adult human brain was a static organ. It was widely believed that once we reached adulthood, the brain’s physical structure and its neural pathways were permanently fixed, and any damage—whether from injury, stroke, or disease—was entirely irreversible. However, the paradigm-shifting discovery of neuroplasticity has fundamentally dismantled this dogmatic view, revealing the brain as a highly dynamic and malleable entity capable of reorganizing itself throughout an individual’s lifespan.\n\nNeuroplasticity, or brain plasticity, refers to the brain\'s intrinsic ability to form new neural connections, reassign functional roles across different cortical areas, and even generate new neurons—a process known as neurogenesis—in response to learning, experience, or environmental changes. This remarkable adaptability occurs at varying scales, ranging from microscopic changes in individual synapses to macro-level cortical remapping following severe injury.\n\nOne of the most compelling demonstrations of neuroplasticity involves London taxi drivers. To acquire their license, these drivers must memorize "The Knowledge," an incredibly complex mental map of thousands of streets and landmarks. Neuroimaging studies conducted by Eleanor Maguire at University College London revealed that the posterior hippocampi of these taxi drivers—a brain region heavily implicated in spatial navigation and memory—were significantly larger than those of control subjects. Furthermore, the volume of this brain region correlated directly with the number of years they had spent driving a taxi, providing robust evidence that intensive learning physically alters brain structure.\n\nHowever, neuroplasticity is not inherently beneficial; it is a neutral mechanism that can yield maladaptive outcomes. For instance, in individuals suffering from chronic pain or phantom limb syndrome, the brain\'s sensory maps reorganize in ways that perpetuate suffering. Similarly, the neurological pathways of addiction are forged through the same plastic mechanisms that enable us to learn a new language or play an instrument, as the brain wires itself to compulsively seek a chemical reward.\n\nHarnessing the power of positive neuroplasticity forms the foundation of modern cognitive rehabilitation. Through targeted, repetitive therapies, stroke survivors can often regain lost motor functions by training undamaged brain regions to assume the responsibilities of the necrotic tissue. This underscores a profound physiological truth: our daily habits, cognitive exercises, and focal points of attention are actively sculpting the physical architecture of our brains.',
    wordCount: 382,
    vocabularyHighlights: ['static', 'irreversible', 'malleable', 'intrinsic', 'neurogenesis', 'compelling', 'implicated', 'maladaptive', 'rehabilitation', 'necrotic'],
    questions: [
      { id: 'r18q1', type: 'true_false_not_given', question: 'Historically, scientists believed that neurogenesis frequently occurred in adult brains.', options: ['True', 'False', 'Not Given'], correctAnswer: 'False', explanation: 'The passage says the historical view was that the adult brain was a "static organ" and neural pathways were "permanently fixed".' },
      { id: 'r18q2', type: 'true_false_not_given', question: 'Eleanor Maguire\'s study proved that people with naturally larger hippocampi are more likely to become London taxi drivers.', options: ['True', 'False', 'Not Given'], correctAnswer: 'False', explanation: 'The study showed the volume correlated with "the number of years they had spent driving", proving the job altered the brain, not that they were born with a larger hippocampus.' },
      { id: 'r18q3', type: 'true_false_not_given', question: 'Neuroplasticity can be responsible for negative conditions such as addiction and chronic pain.', options: ['True', 'False', 'Not Given'], correctAnswer: 'True', explanation: 'The passage explicitly states neuroplasticity can yield "maladaptive outcomes", citing chronic pain and addiction as examples.' },
      { id: 'r18q4', type: 'multiple_choice', question: 'The final paragraph suggests that stroke survivors recover because:', options: ['Their brain heals the dead tissue.', 'Undamaged parts of the brain are trained to take over lost functions.', 'They take specialized chemical rewards.', 'Their brains revert to a childhood state of plasticity.'], correctAnswer: 'Undamaged parts of the brain are trained to take over lost functions.', explanation: 'The text states they "regain lost motor functions by training undamaged brain regions to assume the responsibilities of the necrotic tissue".' }
    ],
